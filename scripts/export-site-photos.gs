 ...
 *   1. Go to script.google.com → New project (or reuse the project that has
 *      generate-survey-forms.gs / backfill-firestore-to-forms.gs).
 *   2. Add a file, paste this whole script in, save.
 *   3. Choose "exportSitePhotos" in the function dropdown → Run.
 *   4. Approve the permission prompt (Drive, Docs, and fetching a URL — the
 *      Firestore REST call).
...
var SITES = [
 {
  ...
  "docId": "1hi3EOzztZtXfQg1l2AOOUvF-GYU15UXpPYr5GBOq2Po",
 ...
 },
 {
  ...
  "docId": "1hUD1IZNAC5zsIKK7bXp0d7iTvxpcAdYHAtu7-23nIQU",
 ...
 },
 {
  ...
  "docId": "1_rfmOIf0gtqDg8xd2FniQwfTlqtENH56SlrNaemfqQY",
  "photosFolderId": "1Okl97PD_Ibib-wq7iN-_zwtp1SzunVud",
  "photos": [
   {
